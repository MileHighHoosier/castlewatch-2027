...
- **Governing sources:** [PROJECT_STATE.md](PROJECT_STATE.md), [ROADMAP.md](ROADMAP.md), backend issue [#90](https://github.com/MileHighHoosier/castlewatch-2027/issues/90), frontend PR [#57](https://github.com/MileHighHoosier/castlewatch-frontend/pull/57), the [Phase 2 contract](docs/reservation-awareness-phase-2.md), and the [Phase 2A checkpoint](docs/reservation-awareness-phase-2a.md).
...
| CW-017 | Reservation Awareness Phase 2A | Add the booking-target contract and deterministic booking-window engine | IN_PROGRESS | User + Codex | Additive/version-tolerant targets normalize safely; opening/deadline calculations expose rule provenance, as-of/verification state and per-date overrides; existing reservations, shared sync/history, itinerary control, family-key recovery and production data remain unchanged | None | IN_REVIEW | [issue #90](https://github.com/MileHighHoosier/castlewatch-2027/issues/90), [frontend PR #57](https://github.com/MileHighHoosier/castlewatch-frontend/pull/57), [checkpoint](docs/reservation-awareness-phase-2a.md) | 2026-09-08 | Review both PRs, exact-head CI and the authoritative frontend preview; do not merge, deploy, finalize 2A or begin Phase 2B. |
