...
- **Current phase:** Reservation Awareness Phase 2A (CW-017) is active and published for review.
- **Current blocker:** no technical blocker is known; exact-head CI and the authoritative frontend preview passed, so CW-017 now awaits the user's separate review and Finalize decision.
- **Exact next command:** review the [Phase 2A checkpoint](docs/reservation-awareness-phase-2a.md); if accepted, separately authorize `Finalize Reservation Awareness Phase 2A`. Do not begin Phase 2B.
- **Governing sources:** [PROJECT_STATE.md](PROJECT_STATE.md), [ROADMAP.md](ROADMAP.md), backend issue [#90](https://github.com/MileHighHoosier/castlewatch-2027/issues/90), frontend PR [#57](https://github.com/MileHighHoosier/castlewatch-frontend/pull/57), documentation PR [#91](https://github.com/MileHighHoosier/castlewatch-2027/pull/91), the [Phase 2 contract](docs/reservation-awareness-phase-2.md), and the [Phase 2A checkpoint](docs/reservation-awareness-phase-2a.md).
...
| CW-011 | Product roadmap | Reservation Awareness Phase 2 and 60-day planner | IN_PROGRESS | User + Codex | Booking windows, priorities, statuses, in-app reminders and contingency choices are implemented through separately approved 2A–2D checkpoints | None | IN_REVIEW | [issue #85](https://github.com/MileHighHoosier/castlewatch-2027/issues/85), [contract](docs/reservation-awareness-phase-2.md) | 2026-09-08 | Complete and separately finalize CW-017 before authorizing any Phase 2B work. |
| CW-017 | Reservation Awareness Phase 2A | Add the booking-target contract and deterministic booking-window engine | IN_PROGRESS | User + Codex | Additive/version-tolerant targets normalize safely; opening/deadline calculations expose rule provenance, as-of/verification state and per-date overrides; existing reservations, shared sync/history, itinerary control, family-key recovery and production data remain unchanged | None | PASSED | [issue #90](https://github.com/MileHighHoosier/castlewatch-2027/issues/90), [frontend PR #57](https://github.com/MileHighHoosier/castlewatch-frontend/pull/57), [documentation PR #91](https://github.com/MileHighHoosier/castlewatch-2027/pull/91), [checkpoint](docs/reservation-awareness-phase-2a.md) | 2026-09-08 | Review the passed checklist; if accepted, separately authorize Phase 2A Finalize. Do not merge, deploy or begin Phase 2B before that authorization. |
