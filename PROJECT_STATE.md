...
1. Verify the final documentation PR #97 head and exact-head CI.
2. Perform an independent review of frontend head `bb54a926f284dc5671bb22a3ffb227523b9625fd` and the final documentation head before any Finalize command; do not merge or deploy during review.
